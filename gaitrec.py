...
## OU-InertialGaitData
#ou_isir_data = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/Android/*.csv'
#ou_isir_data_out = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/Android/out/'
#ou_isir_data_out_files = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/Android/out/*.csv'
#
#ou_isir_imuzcenter = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/IMUZCenter/*.csv'
#ou_isir_imuzcenter_out = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/IMUZCenter/out/'
#
#ou_isir_imuzleft = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/IMUZLeft/*.csv'
#ou_isir_imuzright = '/Users/rickyputra/Projects/Gait/OU-IneritialGaitData/ManualExtractionData/IMUZRight/*.csv'
##
#
## Remove first and second rows, and create new files in out subdir
#files = glob.glob(ou_isir_imuzcenter)
#for name in files:
#    try:
#        with open(name) as f:
...
#        with open(ou_isir_imuzcenter_out + fileName, 'w+') as fout:
...
#files = glob.glob(ou_isir_imuzcenter_out + '*.csv')
#
#df = None
#
